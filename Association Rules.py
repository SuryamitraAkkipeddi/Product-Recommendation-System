...
dataset = pd.read_csv('E:\\DESK PROJECTS\\MACHINE LEARNING SUMMARY\\ML DATASETS\\Market_Basket_Optimisation.csv', header = None)
transactions = []
...
####################################################################################################################################
#######################  III> TRAINING APRIORI MODEL ON DATASET ####################################################################
####################################################################################################################################
